                    ...
                    <article>
                        ...
                        <PageTransition delay={0.5}>
                            <p>
                                ...
                                <span className="highlight">Informatics</span> and a self-taught full-stack developer
                                from Indonesia.
                            </p>
                        </PageTransition>
                        <PageTransition delay={0.6}>
                            <p>
                                I have been programming for at least 5 years now, and I have an interest in{" "}
                                ...
                                <span className="highlight">TypeScript</span> in the past, but I&apos;m also familiar
                                with <span className="highlight">PHP</span> and also currently learning{" "}
                                <span className="highlight">Go</span>.
                            </p>
                        </PageTransition>
                    </article>
                    <PageTransition delay={0.7}>
                        <div>
                            <Link href="/about">
                                More About Me
                                <svg
